...
void *
trie_nsearch_ambiguous(const struct trie *self, const char *key, size_t length, unsigned *ambiguous, void **partial)
{
    struct trie *child;
    struct trieptr *parent;
    unsigned char *ukey = (unsigned char *)key;
