...
__CIDENT_RCSID(gr_edthreads_win32_c,"$Id: edthreads_win32.c,v 1.23 2022/12/03 16:33:05 cvsuser Exp $")

/* -*- mode: c; indent-width: 4; -*- */
/* $Id: edthreads_win32.c,v 1.23 2022/12/03 16:33:05 cvsuser Exp $
