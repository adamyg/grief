...
__CIDENT_RCSID(gr_edthreads_win32_c,"$Id: edthreads_win32.c,v 1.25 2025/01/13 16:06:38 cvsuser Exp $")

/* -*- mode: c; indent-width: 4; -*- */
/* $Id: edthreads_win32.c,v 1.25 2025/01/13 16:06:38 cvsuser Exp $
