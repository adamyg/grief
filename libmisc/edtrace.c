...
__CIDENT_RCSID(gr_edtrace_c,"$Id: edtrace.c,v 1.40 2015/02/19 00:17:11 ayoung Exp $")

/* -*- mode: c; indent-width: 4; -*- */
/* $Id: edtrace.c,v 1.40 2015/02/19 00:17:11 ayoung Exp $
