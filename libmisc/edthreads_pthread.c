...
__CIDENT_RCSID(gr_edthreads_pthread_c,"$Id: edthreads_pthread.c,v 1.12 2022/09/20 15:19:11 cvsuser Exp $")

/* -*- mode: c; indent-width: 4; -*- */
/* $Id: edthreads_pthread.c,v 1.12 2022/09/20 15:19:11 cvsuser Exp $
