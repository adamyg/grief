...
#if defined(DUK_F_DLL_BUILD) && defined(DUK_F_WINDOWS)
/* WC dllexport/dllimport: appropriate __declspec depends on whether we're
 * compiling Duktape or the application.
 */
#if defined(DUK_COMPILING_DUKTAPE)
#define DUK_EXTERNAL_DECL  extern __declspec(dllexport)
...
#if defined(DUK_F_CPP)
#define DUK_USE_COMPILER_STRING "wc++"
#else
#define DUK_USE_COMPILER_STRING "wc"
#endif
...
#pragma disable_message ( 124 ) //comparision always zero
#pragma disable_message ( 136 ) //comparison equivalent to 'unsigned == 0'
#pragma disable_message ( 201 ) //unreachable code
#pragma disable_message ( 202 ) //unused function

#define DUK_UNREF(__x)  (void)__x
