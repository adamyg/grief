...
__CIDENT_RCSID(gr_edthreads_win32_h,"$Id: edthreads_win32.h,v 1.21 2025/01/13 16:20:07 cvsuser Exp $")
__CPRAGMA_ONCE

/* -*- mode: c; indent-width: 4; -*- */
/* $Id: edthreads_win32.h,v 1.21 2025/01/13 16:20:07 cvsuser Exp $
 * Threads interface
