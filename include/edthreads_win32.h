...
__CIDENT_RCSID(gr_edthreads_win32_h,"$Id: edthreads_win32.h,v 1.19 2023/01/01 11:26:59 cvsuser Exp $")
__CPRAGMA_ONCE

/* -*- mode: c; indent-width: 4; -*- */
/* $Id: edthreads_win32.h,v 1.19 2023/01/01 11:26:59 cvsuser Exp $
 * Threads interface
