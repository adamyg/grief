...
__CIDENT_RCSID(gr_edthreads_win32_h,"$Id: edthreads_win32.h,v 1.20 2024/04/08 15:07:03 cvsuser Exp $")
__CPRAGMA_ONCE

/* -*- mode: c; indent-width: 4; -*- */
/* $Id: edthreads_win32.h,v 1.20 2024/04/08 15:07:03 cvsuser Exp $
 * Threads interface
