...
#if !defined(HAVE_LIBZ) && (defined(_MSC_VER) || defined(__WATCOMC__))
#define HAVE_LIBZ
#endif
...
#if !defined(HAVE_SYS_PARAM_H) && (defined(_MSC_VER) || defined(__WATCOMC__))
...
#if !defined(HAVE_WCHAR_H) && (defined(_MSC_VER) || defined(__WATCOMC__))
#define HAVE_WCHAR_H
#endif

/* Define to 1 if you have the <wctype.h> header file. */
#if !defined(HAVE_WCTYPE_H) && (defined(_MSC_VER) || defined(__WATCOMC__))
...
#if !defined(HAVE_ZLIB_H) && (defined(_MSC_VER) || defined(__WATCOMC__))
#define HAVE_ZLIB_H
#endif
...
#if !defined(STDC_HEADERS) && (defined(_MSC_VER) || defined(__WATCOMC__))
#define STDC_HEADERS
#endif
