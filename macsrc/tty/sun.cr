 ...
 *  type 3 keyboard or various other things. Refer to config guide for more info On a sun-3
 *  keyboard, you should type: 'setkeys nosunview' so that we can trap the L* keys. (We cannot get
 *  at L1 because that seems to be hardwired
 *
 *
 */
...
main()
{
    ...
    set_term_keyboard(
        F1_F12, quote_list(
            "\x1B[234z",    "\x1B[234z",    "\x1B[203z",    "\x1B[235z",    "\x1B[204z",
            "\x1B[236z",    "\x1B[205z",    "\x1B[237z",    "\x1B[206z",    "\x1B[238z"),

        SHIFT_F1_F12, quote_list(
            "\x1B[202z",    "\x1B[225z",    "\x1B[226z",    "\x1B[227z",    "\x1B[228z",
            "\x1B[229z",    "\x1B[230z",    NULL,           NULL),
        ...
        KEYPAD_0_9, quote_list(
            ...
            "\x1B[218z",    "\x1B[C",       "\x1B[214z",    "\x1B[A",       "\x1B[216z",
            "\x1B[P",       "\x1B[213z",    "\x1B[210z"),
...
/*
 *  key bindings for a type3 keyboard
 */
void
type3()
{
...
/*
 *  keyboard layout for Sun/4 keyboard
 */
void
type4()
{
    set_term_keyboard(
        KEYPAD_0_9, quote_list(
            "\x1B[247z",    "\x1B[220z",    "\x1B[B",       "\x1B[222z",    "\x1B[D",
            "\x1B[218z",    "\x1B[C",       "\x1B[214z",    "\x1B[A",       "\x1B[216z",
            "\x1B[249z",    "\x1B[253z",    "\x1B[254z",    "\x1B[213z"));
    ...
    set_term_keyboard(
        F1_F12, quote_list(
            "\x1B[234z",    "\x1B[225z",    "\x1B[226z",    "\x1B[227z",    "\x1B[228z",
...
/*
 *   crttool program,
 *      which supports full color VT220 emulation, yet remaps the keyboard the way a VT220 does
 */
void
crttool()
{
...
/*
 *  Macro called to tell GRIEF we are running on a mono screen
 */
void
mono()
{
...
/*
 *  running a shell/cmdtool with the xmodmap running (in crisp/utils/xmodmaprc)
 */
void
xmodmap()
{
