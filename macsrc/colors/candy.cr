...
/* $Id: candy.cr,v 1.4 2024/10/07 16:14:59 cvsuser Exp $
 * Candy coloriser, GRIEF port.
 *
 * Original:
 *  Name: candy.vim
 ...
 *  version: 1.0
 *
 *  Notes: This color scheme uses a dark background.
 */
...
void
colorscheme_candy(void)
{
        vim_colorscheme("candy", 256, NULL, candy_gui, TRUE);
}
