...
/* $Id: wombat.cr,v 1.4 2024/08/04 11:42:44 cvsuser Exp $
 * wombat coloriser, GriefEdit port.
 *
 * Original:
 *  Name: wombat256.vim
...
void
colorscheme_wombat(void)
{
        vim_colorscheme("wombat", 256, NULL, wombat_colors, -1);
}
/*end*/
