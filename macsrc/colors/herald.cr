...
/* $Id: herald.cr,v 1.5 2024/10/07 16:14:59 cvsuser Exp $
...
herald_256 = {
     ...
     // "hi! default link bbcodeUnderline htmlUnderline",
        ...
        "hi SpellCap "                    +"ctermfg=160 cterm=undercurl",
        "hi SpellLocal "                  +"ctermfg=160 cterm=undercurl",
        "hi SpellRare "                   +"ctermfg=160 cterm=undercurl"
        };
...
herald_16 = {
     ...
     // "hi! default link bbcodeUnderline htmlUnderline",
        ...
        "hi SpellLocal "                  +"ctermfg=1 cterm=undercurl",
        "hi SpellRare "                   +"ctermfg=1 cterm=undercurl"
        };

void
colorscheme_herald(void)
{
        ...
        if (truecolor) {
                vim_colorscheme("herald_gui", 256, NULL, herald_gui, TRUE);

        } else if (colordepth >= 88) {
                vim_colorscheme("herald_256", 256, NULL, herald_256, FALSE);

        } else {
                vim_colorscheme("herald_16", 16, NULL, herald_16, FALSE);
        }
}
