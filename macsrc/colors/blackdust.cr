...
/* $Id: blackdust.cr,v 1.8 2024/10/07 16:14:59 cvsuser Exp $
 * blackdust coloriser, GRIEF port.
 *
 *
 */
...
void
colorscheme_blackdust(void)
{
        vim_colorscheme("blackdust", 256, NULL, blackdust_256, FALSE);
}
