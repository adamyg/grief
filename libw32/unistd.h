...
__CIDENT_RCSID(gr_libw32_unistd_h,"$Id: unistd.h,v 1.73 2024/06/09 14:05:43 cvsuser Exp $")
__CPRAGMA_ONCE
...
#if (_MSC_VER > 1940)                           /* MSVC 2022: 19.30 .. 40 */
#error unistd.h: untested MSVC Version (2005 -- 2022 19.40)
