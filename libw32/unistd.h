...
__CIDENT_RCSID(gr_libw32_unistd_h,"$Id: unistd.h,v 1.67 2022/08/29 16:07:36 cvsuser Exp $")
__CPRAGMA_ONCE
...
#if (_MSC_VER > 1933)                           /* MSVC 2022: 19.30 .. 32 */
#error unistd.h: untested MSVC Version (2005 -- 2019.33)
